...
public enum UserOptions {
    ...
    MENU_OPTION_LIST_SUBSCRIBER(3, Messages.MENU_OPTION_LIST_SUBSCRIBER),

    MENU_OPTION_SEND_BROADCAST(4, Messages.MENU_OPTION_SEND_BROADCAST),

    QUIT(5, Messages.MENU_OPTION_QUIT);
